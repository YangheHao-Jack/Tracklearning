...
# ------------------------------
# 3. U-Net Model Definition with ResNet Encoder
# ------------------------------
...
class ResNetUNet(nn.Module):
    ...
    def __init__(self, n_classes=2, encoder_name='resnet34', pretrained=True):
        ...
        self.encoder_layer1 = self.encoder.layer1  # [B, 64, H/4, W/4] for resnet34
        self.encoder_layer2 = self.encoder.layer2  # [B, 128, H/8, W/8]
        self.encoder_layer3 = self.encoder.layer3  # [B, 256, H/16, W/16]
        self.encoder_layer4 = self.encoder.layer4  # [B, 512, H/32, W/32]
    ...
    def modify_first_conv_layer(self, in_channels=1):
        """
        Modifies the first convolutional layer of the ResNet encoder to accept single-channel input.
        
        Args:
            in_channels (int): Number of input channels.
        """
        # Replace the first conv layer
        self.encoder.conv1 = nn.Conv2d(in_channels, 
        ...
        # Initialize weights by averaging the existing weights across the channel dimension
        with torch.no_grad():
            if in_channels == 1:
    ...
    def forward(self, x):
        ...
        x1 = self.encoder_layer1(x0)   # [B, 64, H/4, W/4]
